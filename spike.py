...
from pybricks.pupdevices import Motor, ColorSensor, UltrasonicSensor, GyroSensor
...
def get_gyro_angle():
    # The SPIKE's built-in IMU uses roll, pitch, and yaw
    return (gyro.tilt_angle() + 180) % 360 - 180
